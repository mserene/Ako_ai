...
class LoadingOverlay(tk.Frame):
    def __init__(self, master: tk.Misc, on_done: Callable[[], None] | None = None):
        super().__init__(master, bg="#02040a", highlightthickness=0, bd=0)
    ...
    def _build_scene(self):
        ...
        # smooth radial glow with many soft layers
        ...
        # initially hidden by cover mask
    ...
    def _animate_glow(self):
        # slightly breathe center darkness/brightness
        breathe = (math.sin(self.phase * 0.9) + 1) / 2
        percent = self.progress / 100.0
